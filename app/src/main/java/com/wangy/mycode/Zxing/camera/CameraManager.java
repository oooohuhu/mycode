...
package com.wangy.mycode.Zxing.camera;
...
public final class CameraManager {
  ...
  public void openDriver(SurfaceHolder holder) throws IOException {
    ...
    if (camera == null) {
      ...
      System.out.println("wangying openDriver camera != null");
      camera.setPreviewDisplay(holder);//此处为新增方法
    }
/***
 * 以上内容为更改内容，经实践结果我们发现，viewfinder会出现黑屏的情况，以上内容就是解决的方法，
 * 我遇到的情况是我从相册中选取图片进行扫描的时候，返回扫描界面的时候就出现viewFinder黑屏，大家复制上面
 * 的内容，放到这个方法就可以啦！
 */
...
//    }
  ...
  public Rect getFramingRect() {
    ...
    if (framingRect == null) {
      ...
      int height = screenResolution.y * 3 / 6;
